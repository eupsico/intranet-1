  ...
  <div class="info-card">
   ...
   <div class="form-group">
           <label class="form-label" style="font-size: 16px; color: #28a745; display:flex; align-items: center; gap: 8px;">
               <i class="fas fa-envelope"></i> Mensagem de Boas-Vindas (para E-mail)
           </label>
   ...
   <label class="form-label" for="link-formulario-cadastro" style="display:flex; align-items: center; gap: 8px;">
    <i class="fab fa-whatsapp" style="color: #25D366;"></i> Link do Formulário (para WhatsApp):
   </label>
   <input type="text" id="link-formulario-cadastro" class="form-input"
    value="Carregando link..." readonly>
   </div>
   <p style="font-size: 12px; color: #6c757d;">
    Copie a mensagem de boas-vindas (para o e-mail) e o link do formulário (para o WhatsApp).
         <br>Após o envio, clique em "Marcar como Enviado".
   </p>
  </div>
